  ...
  return (
    <div className="mt-8 bg-white flex flex-col items-start text-lg shadow-lg rounded-sm">
      ...
      <div className="flex text-start flex-col pb-12 lg:px-20 lg:w-[740px] md:w-[90vw] md:px-[2.5vw] w-[95vw] px-[2.5vw]">
        ...
        <Image
          src="/imgs/长沙之旅/IMG_3860(20231003-183823).JPG"
          alt="房间"
          width="700"
          height="450"
        />
        ...
        <p>
          ...
          道菜就花掉 300 大洋
          <Image
            src="/imgs/长沙之旅/IMG_3861(20230929-190127).JPG"
            alt="靓虾二哥"
            width="700"
            height="450"
          />
          <Image
            src="/imgs/长沙之旅/IMG_3862(20230929-190008).JPG"
            alt="靓虾二哥"
            width="700"
            height="450"
          />
          <Image
            src="/imgs/长沙之旅/IMG_3863(20230929-194926).JPG"
            alt="靓虾二哥"
            width="700"
            height="450"
          />
        ...
        <p>
          如果自己有相机，估计也能拍出这样的图
          <Image
            src="/imgs/长沙之旅/IMG_3663(20231003-023127).JPG"
            alt="杜甫江阁"
            width="700"
            height="450"
          />
          <Image
            src="/imgs/长沙之旅/IMG_3643.JPG"
            alt="杜甫江阁"
            width="700"
            height="450"
          />
        ...
        <p>
          ...
          <Image
            src="/imgs/长沙之旅/IMG_3836(20231003-023128).JPG"
            alt="10点的早餐"
            width="700"
            height="450"
          />
          ...
          直接回酒店吃午餐（外卖） 午餐
          <Image
            src="/imgs/长沙之旅/IMG_3842(20231003-023128).JPG"
            alt="主打的就是丰富"
            width="700"
            height="450"
          />
        ...
        <p>
          ...
          <Image
            src="/imgs/长沙之旅/IMG_3840(20231003-023128).JPG"
            alt="杨帆夜市"
            width="700"
            height="450"
          />
          <Image
            src="/imgs/长沙之旅/IMG_3841(20231003-023128).JPG"
            alt="杨帆夜市"
            width="700"
            height="450"
          />
          <Image
            src="/imgs/长沙之旅/IMG_3839(20231003-023128).JPG"
            alt="杨帆夜市"
            width="700"
            height="450"
          />
          <Image
            src="/imgs/长沙之旅/IMG_3721.JPG"
            alt="杨帆夜市"
            width="700"
            height="450"
          />
          <Image
            src="/imgs/长沙之旅/IMG_3725.JPG"
            alt="杨帆夜市"
            width="700"
            height="450"
          />
        ...
        <p>
          夜市没吃饱，少不了夜宵
          <Image
            src="/imgs/长沙之旅/IMG_3837(20231003-023128).JPG"
            alt="一天四顿"
            width="700"
            height="450"
          />
        ...
        <p>
          ...
          <Image
            src="/imgs/长沙之旅/IMG_3835(20231003-023128).JPG"
        ...
        <Image
          src="/imgs/长沙之旅/IMG_3832(20231003-023128).JPG"
          alt="加了红糖的糍粑罢了"
          width="700"
          height="450"
        />
