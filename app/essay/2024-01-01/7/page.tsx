  ...
  return (
    <div className=" mt-8 bg-white w-[60vw] flex flex-col items-start text-lg">
      ...
      <div className="flex text-start flex-col pb-12 px-24 w-[50vw]">
        ...
        <Image
          src="/imgs/我的2023/music.png"
          alt="拙劣的模仿"
          width="700"
          height="450"
        />
        <Image
          src="/imgs/我的2023/venue.png"
          alt="后台管理"
          width="700"
          height="450"
        />
        ...
        <p>
          ...
          <Image
            src="/imgs/我的2023/wuhan.JPG"
            alt="武汉"
            width="700"
            height="450"
          />
          <Image
            src="/imgs/我的2023/changsha.JPG"
            alt="长沙"
            width="700"
            height="450"
          />
