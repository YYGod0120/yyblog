...
export default function Page() {
  ...
  return (
    ...
    <div className="flex text-start break-words flex-col pb-12 lg:px-20 lg:w-[740px] md:w-[90vw] md:px-[2.5vw] w-[95vw] px-[2.5vw]">
      <blockquote>
<p>本身在重庆读书，但是对重庆也没咋探索过，仅限于学校周边。这次五一以一个游客的视角探索一下重庆</p>
</blockquote>
<h1>第一天</h1>
<p>因为本身在重庆，所以并不需要像去年旅游那样早早赶高铁，一觉睡到8点半准备去办酒店入住。</p>
<p>酒店本身还有点远，从一号线头坐到尾巴，住在沙坪坝附近。好在酒店附近就是天街广场，还有一个小夜市，夜宵问题解决了。</p>
<blockquote>
<p>Flower for love</p>
</blockquote>
<Image src={flower} alt="flower for love" 
      sizes="100vw"
      style={{
        width: '100%',
        height: 'auto',
...
<p>这次不得不说一下男女生出门的区别了，男生洗漱拉屎穿衣服10min轻松搞定，女生化妆就要化45min，七七八八的事情够我睡一个回笼觉。</p>
<p>早上天气还行，我们直接去了朝天门和来福士。</p>
<Image src={chaotianmen} alt="朝天门" 
      sizes="100vw"
      style={{
        width: '100%',
        height: 'auto',
...
<blockquote>
<p>上次被剪纸画坑了188，这次被流水线拍照拍了100块钱。真的是随意拍加流水线工程。</p>
</blockquote>
<p>人相比于解放碑还是少了，解放碑才是真正的水泄不通，而且还是大中午。</p>
<Image src={jiefanbei} alt="解放碑" 
      sizes="100vw"
      style={{
        width: '100%',
        height: 'auto',
...
<p>吃饱喝足去逛了逛老街一路逛到老君洞。爬坡爬坡还是爬坡。最后老君洞人也一样还是好多。</p>
<Image src={nanshan} alt="南山" 
      sizes="100vw"
      style={{
        width: '100%',
        height: 'auto',
...
<p>不得不说南山上风景还是在线的。</p>
<p>晚上想着去一下洪崖洞，但是脚也是实在受不了就放弃了，直接回酒店休息了。
点了一顿也是唯一一顿烧烤外卖。</p>
<h1>第三天</h1>
<p>一样的八点起床，一样的九点半出门。</p>
<p>目的地山城步道和十八梯。这两个地方本来应该是挺不错的徒步的路线，从居民楼穿来穿去，体验一下那种山城的氛围。但是五一人流量太大了，只能感受到人感受不到城。</p>
<Image src={binqilin1} alt="山城冰淇淋" 
      sizes="100vw"
      style={{
        width: '100%',
        height: 'auto',
...
<p>穿楼电车其实一般，甚至说下面看电车穿楼还不如在电车上看下面的人挤成一团。</p>
<Image src={chuanglou} alt="李子坝穿楼" 
      sizes="100vw"
      style={{
        width: '100%',
        height: 'auto',
...
<h1>总结</h1>
<p>重庆，是一个充满热情的城市。它会用滚烫的火锅招待你，用骄阳似火的天气迎接你。住在山城里的人，无论男女老少都操着一口重庆话帮你指路。</p>
<p>重庆更是一座适合旅游的城市，消费水平远低于北上广深。它有不同于其他城市的垂直高度，会教训每一个不运动的人。</p>
<p>火锅串串烤苕皮冰粉更是站在美食的山顶，代表重庆的特色美食。</p>
<blockquote>
<p>“我喜欢重庆，也许是因为你在，也许是因为美食，也许是因为这的人热情。不管怎样，我就是喜欢这里” -最爱的人</p>
</blockquote>
