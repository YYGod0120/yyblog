      ...
      <div className="mt-8 flex flex-col items-start rounded-sm bg-white text-lg shadow-lg">
        ...
        <div className="flex w-[95vw] flex-col break-words px-[2.5vw] pb-12 text-start md:w-[90vw] md:px-[2.5vw] lg:w-[740px] lg:px-20">
          ...
          <ol>
            <li>
              <p>
                做前端开发，难免要与各种APP（qq微信）内置浏览器打交道，如何调试不同的WEBVIEW成了一个难题。
              </p>
              <p>
              ...
              <ol>
                <li>
                  <p>
                    远程调试页面WEBVIEW，Chrome提供了内置的办法
                    <a href="https://developer.chrome.com/docs/devtools/remote-debugging/webviews?hl=zh-cn">
                      远程调试 WebView
                    </a>
                  </p>
                </li>
                <li>
                  <p>
                    想要手机查看本地开发环境的页面，起一个本机服务器让手机端访问。
                  </p>
                  <p>
                    如果你使用vite的话，可以用<code>vite dev --host</code>
                    起一个服务器。
                  </p>
                  <Image
                    src={host}
            ...
            <li>
              <p>
                <a href="https://blog.vuejs.org/posts/vitepress-1.0">
                  vitepress发布1.0
                </a>
                ：vitepress是近几年来很火的博客框架，如果你是一个不想动手自定义一个个人博客的话，vitepress是一个很好的上手博客框架
              </p>
            </li>
            <li>
              <p>
                <a href="https://joyeecheung.github.io/blog/2024/03/18/require-esm-in-node-js/">
                  require esm in nodejs
                </a>
                : 本该早几年就实现的功能，最近才发出实现性功能，作者表示很无奈。
              </p>
            </li>
          </ol>
          <h2>Reading</h2>
          <ol>
            <li>
              <p>
                来自少数派的一篇文章-
                <a href="https://sspai.com/post/86697">
                  现代打工人如何获得幸福？
                </a>
              </p>
              <p>
            ...
            <li>
              <p>
                同样一篇来自少数派的文章-
                <a href="https://sspai.com/post/87551">
            ...
            <li>
              <p>来自陈皓大佬的两篇文章：</p>
              <p>
                <a href="https://coolshell.cn/articles/19085.html">
                  1. 何为三观
                </a>
              </p>
              <p>
                <a href="https://coolshell.cn/articles/17972.html">
                  2. 对绩效制度的批判
                </a>
              </p>
            </li>
