      ...
      <div className="mt-8 flex flex-col items-start rounded-sm bg-white text-lg shadow-lg">
        ...
        <div className="flex w-[95vw] flex-col break-words px-[2.5vw] pb-12 text-start md:w-[90vw] md:px-[2.5vw] lg:w-[740px] lg:px-20">
          ...
          <ol>
            ...
            <li>
              <p>
                <a href="https://indiehackertools.net/">
                  程序员不得不爱上的工具箱合集
                </a>
              </p>
            </li>
            <li>
              <p>
                想写写小网站却又没有好用的api，这个你可能需要。
                <a href="https://publicapis.io/">一些公开的api集合</a>
              </p>
            </li>
            <li>
              <p>
                感受一下Google的CR，马上实习也将不得不被CR.
                <a href="https://dub.sh/crcr">googleCR指引</a>
              </p>
            </li>
            <li>
              <p>
                当你想稍后再看某个页面，或者单纯想做个总结摘抄。可以来看看这个
                <a href="https://hoarder.app/">App</a>
              </p>
            </li>
            <li>
              <p>
                TypeScript5.5 Beta，快来看看有什么能用上的技术。
                <a href="https://devblogs.microsoft.com/typescript/announcing-typescript-5-5-beta/">
          ...
          <ol>
            <li>
              <p>
                The
                Boys(黑袍纠察队)S4已经开播5集，集集追，只能说一样的黄暴，但是限制于原著内容少，已经不足以支撑电视剧的体量，不得不扩充原创支线内容导致节奏缓慢，看的想睡觉。但是黑色幽默和大尺度镜头还是值得一看
              </p>
            </li>
            <li>
              <p>暑假要把平凡的世界读完，如果可以还想看看一些名人的自传</p>
            </li>
          </ol>
          <h2>Talking</h2>
          <p>
          ...
          <p>
            字节二面面试官说：
            <strong>
              其实实习生不需要什么所谓的核心竞争力，只要你把你接触的项目读懂，把代码水平提高。能读懂，写好代码，是一个实习生最需要做到的事情。
            </strong>
          </p>
