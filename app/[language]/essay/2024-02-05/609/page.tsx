        ...
        <div className="flex w-[95vw] flex-col break-words px-[2.5vw] pb-12 text-start md:w-[90vw] md:px-[2.5vw] lg:w-[740px] lg:px-20">
          ...
          <ol>
            <li>
              <p>一个有趣的烟花跟随样式</p>
              <p>
                <a href="https://codepen.io/leimapapa/pen/XWGMrvo">
            ...
            <li>
              <p>一只有趣的幽灵(也是我博客上的那只)</p>
              <p>
                <a href="https://codepen.io/supah/pen/OBbzvp">
            ...
            <li>
              <p>Shiki：一个类似于 Highlight.js 的语法高亮器。</p>
              <p>
                <a href="https://shiki-zh-docs.vercel.app/">
                  https://shiki-zh-docs.vercel.app/
                </a>
                博客用<code>react-syntax-highlighter</code>语法高亮组件,使用
                prismjs 或者 highlightjs 进行封装。新旧程度肯定不如 Shiki 新。
              </p>
            </li>
            <li>
              <p>
                一个页面灵感的网站，会点设计对自己开发有不少帮助。
          ...
          <ol>
            <li>
              <p>
                <a href="https://ishadeed.com/article/target-size#for-designers-delivering-a-clear-target-size-spec">
                  设计更好的目标尺寸
                </a>
                ：作为用户，我们总是要和按钮，链接以及卡片等等 UI
                进行交互，一旦这些东西的大小不对，就会造成很大的困扰。作为前端开发，我们有必要了解一下一些设计方面的知识。
              </p>
            </li>
            <li>
              <p>
                <a href="https://arendjr.nl/2023/04/mvp-the-most-valuable-programmer">
                  The Most Valuable Programmer
                </a>
                ： 如何做一个 MVP
                程序员，绝不是写最多的代码，也不是写最有价值的代码，而是成为一个最好的自己。
              </p>
            </li>
          </ol>
          <h2>Life</h2>
          <ol>
            <li>
              <p>
                <a href="https://yyblog-gamma.vercel.app/">NewBlog</a>
                ：新博客搭建完备，功能不多，后面再说。预计年前替换之前那个旧博客。对这个博客感兴趣的可以去看看
                github 上的代码仓库。
              </p>
            </li>
            <li>
              <p>
                幻兽帕鲁火爆全中国，身边就没有没在玩的。98 大洋购入后 2 天疯玩
                20 小时后又感觉索然无味，等后续更新了。
              </p>
              <Image
                src={gametime}
                alt="=game-time"
