      ...
      <div className="mt-8 flex flex-col items-start rounded-sm bg-white text-lg shadow-lg">
        ...
        <div className="flex w-[95vw] flex-col break-words px-[2.5vw] pb-12 text-start md:w-[90vw] md:px-[2.5vw] lg:w-[740px] lg:px-20">
          ...
          <ol>
            <li>
              <p>
                <a href="https://zh.wikipedia.org/wiki/Hosts%E6%96%87%E4%BB%B6">
                  Hosts文件映射
                </a>
                以及
                <a href="https://blog.csdn.net/huangjuan0229/article/details/131166462">
                  二级域名的作用
                </a>
                :我们以后会遇到超级大项目，其中包含多个登录环境多个token和cookies。当我们需要进行本地开发的时候，没法一个一个登录获取对应的cookies的时候，二级域名/多级域名就可以帮我们在线上测试环境中获取到cookies然后在本地的开发环境中实现登录。同时依靠Hosts文件映射到线上环境的同一域名（本地）。
              </p>
            </li>
            <li>
              <p>
                <a href="https://juejin.cn/post/7343132138667016231">
                  关于“泳道”
                </a>
            ...
            <li>
              <p>
                <a href="https://www.patrickzhong.com/TypeScript/">TS手册</a>
                :重新认识一下ts，这本也算是进阶教程。
              </p>
            </li>
          </ol>
          ...
          <ol>
            <li>
              重温Shameless，尺度虽大，但是不会让人感到不适。每个人都有自己的闪光点，却又很喜欢作死，让人又爱又恨。
            </li>
          </ol>
          <h2>Thoughts</h2>
          <p>
